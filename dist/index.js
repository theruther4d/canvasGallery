...
var Gallery = function () {
    function Gallery(el) {
        ...
        this._getSlides(el, function (slides) {
            _this._slides = slides;
            _this._numSlides = slides.length;
            _this._canvas = _this._createCanvas(Math.min(_this._ww, _this._maxWidth), _this._maxHeight);
            _this._context = _this._canvas.getContext('2d');
            _this._addTouchListener(_this._canvas);
            _this._el.appendChild(_this._canvas);
        });
    }

    _createClass(Gallery, [{
        key: '_addTouchListener',
        value: function _addTouchListener(canvas) {
            var _this2 = this;

            this._hammer = new _hammerjs2.default(canvas);
            this._hammer.on('pan', function (e) {
                _this2._lastOffset = e.deltaX;
                _this2._timer.start();
                _this2._timer.on('draw', _this2._panUpdate.bind(_this2));
            });
        ...
        key: '_isPrevTerminal',
        value: function _isPrevTerminal() {
            return this.currentSlide === 0;
        }
    }, {
        key: '_isNextTerminal',
        value: function _isNextTerminal() {
            return this.currentSlide === this._numSlides - 1;
        }
    }, {
        key: '_setDirection',
        value: function _setDirection(e) {
        ...
        key: '_nextSlide',
        value: function _nextSlide(e) {
            var _this3 = this;

            if (Math.abs(e.deltaX) > this._canvasWidth / 6 && !this._isNextTerminal()) {
                (function () {
                    var duration = 250;
                    var transition = new _Interpolation2.default(e.deltaX, (_this3._canvasWidth + _this3._margin) * -1, duration, _this3._timer.time());

                    _this3._timer.on('draw', function (timestamp) {
                        _this3._lastOffset = transition.play(timestamp);
                    });
                ...
                (function () {
                    var duration = 250;
                    var transition = new _Interpolation2.default(e.deltaX, 0, duration, _this3._timer.time());
        ...
        key: '_previousSlide',
        value: function _previousSlide(e) {
            var _this4 = this;

            if (Math.abs(e.deltaX) > this._canvasWidth / 6 && !this._isPrevTerminal()) {
                (function () {
                    var duration = 250;
                    var transition = new _Interpolation2.default(e.deltaX, _this4._canvasWidth + _this4._margin, duration, _this4._timer.time());

                    _this4._timer.on('draw', function (timestamp) {
                        _this4._lastOffset = transition.play(timestamp);
                    });
                ...
                (function () {
                    var duration = 250;
                    var transition = new _Interpolation2.default(e.deltaX, 0, duration, _this4._timer.time());
        ...
        value: function _scaleImageDimensions(imgWidth, imgHeight, width) {
            var multiplier = Math.min(width, this._maxWidth);
            return {
                width: multiplier,
            ...
            slides.forEach(function (slide) {
                ...
                var promise = new Promise(function (resolve, reject) {
                    img.onload = function () {
                        ...
                        var dimensions = _this5._scaleImageDimensions(width, height, _this5._ww);

                        _this5._maxHeight = dimensions.height > _this5._maxHeight ? dimensions.height : _this5._maxHeight;
        ...
        key: '_panUpdate',
        value: function _panUpdate() {
            // console.log( this._lastOffset );
            var multiplier = this._amt / this._canvasWidth;
            var previous = this._slides[this.currentSlide - 1];
            var current = this._slides[this.currentSlide];
            var next = this._slides[this.currentSlide + 1];

            this._context.clearRect(0, 0, this._canvasWidth, this._canvasHeight);
            var imgOffset = Math.min(Math.abs(this._lastOffset * multiplier), this._amt);

            // Draw Previous:
            if (previous) {
                var x = (previous.img.width - this._lastOffset + this._amt * 2 + this._margin * 2) * -1;
        ...
        value: function _createCanvas(width, height) {
            ...
            var slide = this._slides[this.currentSlide];
            var dimensions = this._scaleImageDimensions(slide.width, slide.height, width);
            canvas.width = width;
...
},{"./Interpolation":4,"./Timer":5,"hammerjs":1}],4:[function(require,module,exports){
'use strict';
...
var Interpolation = function (_Emitter) {
    _inherits(Interpolation, _Emitter);

    function Interpolation(start, end, duration, timestamp) {
        _classCallCheck(this, Interpolation);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Interpolation).call(this));

        _this._start = start;
        _this._end = end;
        _this._startTime = timestamp;
        _this._duration = duration;
        _this._willComplete = false;
        return _this;
    }

    _createClass(Interpolation, [{
        key: 'play',
        value: function play(timestamp) {
            ...
            var delta = (timestamp - this._startTime) / this._duration;

            // Returns a number between start and end based on delta of progress.
            // Uses easeInOutQuart easing function:
            var amt = this._start + (this._end - this._start) * delta * delta;
