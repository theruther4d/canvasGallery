        ...
        value: function _bindKeyEvents() {
            ...
            document.addEventListener('keydown', function (e) {
                if (e.keyCode === 37) {
                    if (_this3.pos > 0) {
                        e.preventDefault();
                        _this3.pos -= _this3._arrowMultiplier;
                    }
                } else if (e.keyCode === 39) {
                    if (_this3.pos < _this3._fullWidth) {
                        e.preventDefault();
                        _this3.pos += _this3._arrowMultiplier;
                    }
                } else {
