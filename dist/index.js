...
var Gallery = function (_Emitter) {
    ...
    function Gallery(el) {
        ...
        _this._getSlides(el, function (slides) {
            _this._height = _this._getTallestSlide(slides);
            _this._createCanvasLayers(el);
            _this._slides = [];
            var offsetBefore = 0;

            slides.forEach(function (slide, idx) {
                _this._slides.push(new _Item2.default(_this._ctx, slide, idx, _this._width, _this._height, _this._margin, offsetBefore));
                offsetBefore += Math.min(slide.width, _this._width) + _this._margin;
            });
    ...
    _createClass(Gallery, [{
        ...
        key: '_getTallestSlide',
        value: function _getTallestSlide(slides) {
            var _this2 = this;
