...
var Gallery = function (_Emitter) {
    ...
    function Gallery(_ref) {
        ...
        var _ref$parallaxAmount = _ref.parallaxAmount;
        var parallaxAmount = _ref$parallaxAmount === undefined ? 0.25 : _ref$parallaxAmount;
        ...
        _this._parallaxAmount = parallaxAmount;
        ...
        _this._getSlides(_this._el, function (slides) {
            ...
            slides.forEach(function (slide, idx) {
                _this._slides.push(new _Item2.default(_this._ctx, slide, idx, _this._width, _this._height, _this._margin, slideDimensions[idx].width, slideDimensions[idx].height, _this._parallaxAmount));
            });
...
var Item = function (_Emitter) {
    ...
    _createClass(Item, [{
        ...
        value: function _parallax(dx) {
            var multiplier = Math.round((dx - this.xOffset) * -1 * this.parallaxAmount);
        ...
        value: function _getProps(output, img) {
            ...
            var parallaxAmount = arguments[8];
