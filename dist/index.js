    ...
    _createClass(Gallery, [{
        ...
        value: function _getTallestSlide(slides) {
            ...
            slides.forEach(function (slide) {
                var dimensions = _this2._scaleImageDimensions(slide.width, slide.height, _this2._width);
        ...
        value: function _scaleImageDimensions(width, height, scale) {
            var multiplier = Math.min(width, scale);
            return {
                width: multiplier,
...
var Item = function (_Emitter) {
    ...
    _createClass(Item, [{
        ...
        value: function _onDraw(pos) {
            ...
            var dy = 0;
            var dWidth = Math.min(this.parentWidth, this.width);
            var dHeight = Math.min(this.parentHeight, this.height);
        ...
        value: function _getProps(output, img) {
            ...
            var offsetBefore = arguments.length <= 6 || arguments[6] === undefined ? 0 : arguments[6];
