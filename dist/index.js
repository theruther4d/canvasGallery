...
var Gallery = function () {
    ...
    _createClass(Gallery, [{
        key: '_transition',
        value: function _transition(start, end, duration, callback) {
            var _this2 = this;
            ...
            // backwards
                    ...
                    (function () {
                        var delay = duration / Math.abs(start - end);
                        var boundOnPan = _this2._onPan.bind(_this2);
        ...
        value: function _addTouchListener(canvas) {
            ...
            this._hammer.on('pan', function (e) {
                if (e.additionalEvent === 'panleft') {
                    _this3._lastOffset = e.deltaX;
                    _this3._timer.start();
                    _this3._timer.on('draw', _this3._panUpdate.bind(_this3));
                    // this._onPan( e.deltaX );
                }
            });

            this._hammer.on('panend', function (e) {
                if (Math.abs(e.deltaX) > _this3._canvasWidth / 2) {
                    (function () {
                        var transition = new _Interpolation2.default(e.deltaX, (_this3._canvasWidth + _this3._margin) * -1, 500, _this3._timer.time());
            ...
            slides.forEach(function (slide) {
                ...
                var promise = new Promise(function (resolve, reject) {
                    img.onload = function () {
                        ...
                        var dimensions = _this4._scaleImageDimensions(width, height, _this4._ww);

                        _this4._maxHeight = dimensions.height > _this4._maxHeight ? dimensions.height : _this4._maxHeight;
        ...
        value: function _panUpdate() {
            ...
            var multiplier = this._amt / this._canvasWidth /*/ 2*/;
...
var Interpolation = function (_Emitter) {
    ...
    function Interpolation(start, end, duration, timestamp) {
        ...
        _this._perTick = (end - start) / duration;
    ...
    _createClass(Interpolation, [{
        ...
        value: function play(timestamp) {
            ...
            var which = this._start < this._end ? 'min' : 'max';
