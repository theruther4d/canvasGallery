    ...
    _createClass(Gallery, [{
        ...
        value: function _bindKeyEvents() {
            ...
            document.addEventListener('keydown', function (e) {
                if (_this3._transitioning) {
                    return;
                }

                if (e.keyCode === 37) {
                    e.preventDefault();
                    _this3._goToSlide(_this3.currentSlide - 1);
