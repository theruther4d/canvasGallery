...
var Gallery = function (_Emitter) {
    ...
    function Gallery(el) {
        ...
        _this._width = el.getBoundingClientRect().width;
        _this._maxHeight = 700;
        // this._height = 400;
        _this._margin = 40;
        ...
        _this._getSlides(el, function (slides) {
    ...
    _createClass(Gallery, [{
        ...
        value: function _scaleImageDimensions(width, height, galleryMaxWidth, galleryMaxHeight) {
            ...
            var newWidth = willScaleXAxis ? galleryMaxWidth : width * galleryMaxHeight / height;
            var newHeight = willScaleXAxis ? height * galleryMaxWidth / width : galleryMaxHeight;
        ...
        value: function _draw(timestamp) {
            ...
            this._getSlidesInView(this.pos).forEach(function (idx) {
                _this5._slides[idx].trigger('draw', _this5.pos);
            });
